(deftheme maenoj-dark
  "Created 2023-01-17.")

(custom-theme-set-faces
 'maenoj-dark
 '(default ((t (:family "Liberation Mono" :foundry "1ASC" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "WhiteSmoke" :background "black" :stipple nil :inherit nil))))
 ...
 '(button ((t (:background "grey" :foreground "black" :box (:line-width (2 . 2) :color "grey" :style released-button) :weight bold))))
 ...
 '(mode-line ((t (:background "black" :foreground "cyan" :box (1 . 1) :height 0.9))))
 '(mode-line-buffer-id ((t (:foreground "red" :weight bold :height 0.9))))
 '(mode-line-emphasis ((t (:weight bold))))
 '(mode-line-highlight ((t (:box (:line-width (2 . 2) :color "grey40" :style released-button)))))
 '(mode-line-inactive ((t (:background "gray20" :foreground "gray70" :box (1 . 1) :weight light :height 0.9))))
