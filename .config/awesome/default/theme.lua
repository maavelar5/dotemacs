...
local themes_path = '/home/marco/.config/awesome/'
...
-- theme.wallpaper = themes_path.."default/wallpaper3.png"
-- theme.wallpaper = themes_path.."default/background4.png"
theme.wallpaper = themes_path.."default/wallpaper5.png"
